...
#' @param number_of_parents an integer indicating the number of parents per offspring
...
#' @param pop_required number of offspring needed at the start of the next generation
#'
#'
#'
#' @return a numeric vector indexing which parents are reproducing for the next generation
#' @export
#'
#' @examples
