...
plot(out[[3]], type = 'l', ylab = 'True Score', xlab = 'generations')


#Custom Function List

#dumber_func1 <- function(genes,data) {NA}
#dumber_func2 <- function(genes,data) {Inf}
#dumber_func3 <- function(genes,data) {'Okiedokie'}
#dumb_func_works <- function(genes,data) {1}
